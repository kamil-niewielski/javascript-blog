...
generateTitleLinks();
/* Create function calculateTagFunction */
...
/* Create function calculateTagsParams */
  ...
  /* [NEW] START LOOP: for each tag in allTags  */
    for(let tag in allTags){
      ...
      /* const tagLinkHTML generated by A.I. */
      const tagLinkHTML =   '<li><a class="' + calculateTagsClass(allTags[tag], tagsParams) + '" href="#' + tag + '">' + tag + '</a></li>';
...
/* I am creating object for authors 

let allAuthors = {} // new object for authors
